...
<div class="row">
    <div class="col-md-12">
        <p>
            ...
            <a href="{{ route('export') }}" class="btn btn-flat btn-sm btn-success"><i class="fa fa-print"></i> Export Data</a>
        </p>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    <a href="{{ url('master/buku/'.$dt->id) }}" class="btn btn-flat btn-xs btn-warning"><i class="fa fa-pencil-square"></i></a>
